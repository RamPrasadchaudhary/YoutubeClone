...
const PlayVideo = ({ videoId }) => {
  ...
  const fetchChannelData = async () => {
    ...
    const comment_url = `https://youtube.googleapis.com/youtube/v3/commentThreads?part=snippet%2Creplies&maxResults=10&videoId=${videoId}&key=${API_KEY}`; // Specify maxResults
    const commentsResponse = await fetch(comment_url);
  ...
  return (
    <div className="play-video">
      <iframe
        ...
        referrerPolicy="strict-origin-when-cross-origin" // Corrected to referrerPolicy
